...
```bash
pi install git:github.com/FleetingEcho/pi-handoff@v0.3.0   # pinned tag (recommended)
```
...
pi install -l git:github.com/FleetingEcho/pi-handoff@v0.3.0   # this project only (writes .pi/settings.json, commit it to share with teammates)
...
`pi install git:git@github.com:FleetingEcho/pi-handoff@v0.3.0`
</details>
